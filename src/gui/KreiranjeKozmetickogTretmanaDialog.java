...
public class KreiranjeKozmetickogTretmanaDialog extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public KreiranjeKozmetickogTretmanaDialog(MenadzerKozmetickogSalona mks, JFrame roditelj) {
	...
	public boolean ValidirajFormu() {
		...
		else if(!mkt.proveriJedinstvenostKozmetickogTretmana(nazivKT)) {
			sveOk = false;
	...
	public void KreirajTretman() {
		...
		mkt.dodajKozmetickiTretman(nazivKT, cenaKT, vremeIzvrsavanja, tkt);
		setVisible(false);
		dispose();
	}
